...
const CDP_HOST = process.env.TRADINGVIEW_CDP_HOST || process.env.CDP_HOST || 'localhost';
const CDP_PORT = Number(process.env.TRADINGVIEW_CDP_PORT || process.env.CDP_PORT || 9222);
