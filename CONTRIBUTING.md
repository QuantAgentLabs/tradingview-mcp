...
This tool is a **local bridge** between Codex/MCP clients and the TradingView Desktop app running on your machine. All contributions must stay within this scope.
